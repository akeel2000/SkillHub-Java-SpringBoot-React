...
// SplashScreen component displays an animated splash before redirecting to onboarding
const SplashScreen = () => {
  ...
  return (
    // Main splash background and animated elements
    <div className="relative flex items-center justify-center h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 overflow-hidden">
      {/* Animated spinning circles in the background */}
      ...
      <div className="relative z-10 space-y-8 text-center">
        <div className="animate-float">
          <div className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 lg:text-8xl">
            SkillHub
            {/* Blurred gradient shadow behind the logo */}
      ...
      {/* Animation styles for splash screen */}
      <style jsx global>{`
        @keyframes float {
          0%,
          100% {
