...
const LearningPlans = () => {
  ...
  // Fetch user's learning plans from the backend API when component mounts or user/token changes
  useEffect(() => {
  ...
  // Handle deletion of a learning plan
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          {/* Button to navigate to create a new plan */}
          <button
        ...
        {/* List of plans or empty state message */}
